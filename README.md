...
* [Stanford CS 229 ML Cheatsheets](https://github.com/afshinea/stanford-cs-229-machine-learning) ⭐ 20,205 | 🐛 20 | 📅 2020-05-20
...
* :sunglasses: [TorchGeo](https://github.com/torchgeo/torchgeo) ⭐ 4,177 | 🐛 219 | 🌐 Python | 📅 2026-09-09 [docs](https://torchgeo.readthedocs.io/) - PyTorch domain library with 100+ geospatial datasets, spatial samplers, multispectral transforms, and pretrained backbones
...
* :sunglasses: [GeoAI](https://github.com/opengeos/geoai) ⭐ 3,363 | 🐛 8 | 🌐 Python | 📅 2026-09-07 [docs](https://opengeoai.org/) - Unified Python framework for EO deep learning: segmentation, detection, change detection, and foundation model workflows
...
* :sunglasses: [TerraTorch](https://github.com/IBM/terratorch) ⭐ 859 | 🐛 50 | 🌐 Python | 📅 2026-08-31 [paper](https://arxiv.org/abs/2503.20563) - Fine-tuning and benchmarking toolkit for geospatial foundation models; integrates with GEO-Bench-2 and Hugging Face weights
...
* [ai-models](https://github.com/ecmwf-lab/ai-models) ⭐ 591 | 🐛 7 | 🌐 Python | 📅 2026-08-06 - Open-source CLI to run AI weather models (GraphCast, FourCastNet, Pangu-Weather) with ECMWF data pipelines

* [SeisBench](https://github.com/seisbench/seisbench) ⭐ 416 | 🐛 22 | 🌐 Jupyter Notebook | 📅 2026-08-19 [docs](https://seisbench.readthedocs.io/) - Open toolbox for earthquake ML: phase picking, event detection, pretrained models, and benchmark datasets
...
* [GraphCast / GenCast](https://github.com/google-deepmind/graphcast) ⭐ 7,660 | 🐛 78 | 🌐 Python | 📅 2026-09-04 [GraphCast paper](https://arxiv.org/abs/2212.12794) [GenCast paper](https://arxiv.org/abs/2312.15796) - GNN-based medium-range global weather forecasting and diffusion ensemble forecasting; Apache 2.0
...
* [TEOChat](https://github.com/ermongroup/TEOChat) ⭐ 154 | 🐛 7 | 🌐 Python | 📅 2025-12-01 [paper](https://arxiv.org/abs/2410.06234) - Temporal vision-language assistant for change detection, damage assessment, and EO dialogue
...
* [Awesome Machine Learning](https://github.com/josephmisiti/awesome-machine-learning) ⭐ 74,308 | 🐛 34 | 🌐 Python | 📅 2026-09-08 - ![Awesome](media/icon/awesome.png) A curated list of awesome Machine Learning frameworks, libraries and software
...
* [MindsDB](https://github.com/mindsdb/mindsdb) ⭐ 39,728 | 🐛 5 | 🌐 Makefile | 📅 2026-09-11 – Explainable AutoML framework on PyTorch
* [Netron](https://github.com/lutzroeder/netron) ⭐ 33,474 | 🐛 18 | 🌐 JavaScript | 📅 2026-09-11 – Neural network and ONNX/Keras/TFLite model visualizer
* [MLflow](https://github.com/mlflow/mlflow) ⭐ 27,919 | 🐛 2,092 | 🌐 Python | 📅 2026-09-12 – Machine learning lifecycle platform
* [Dopamine](https://github.com/google/dopamine) ⭐ 10,912 | 🐛 111 | 🌐 Jupyter Notebook | 📅 2026-03-24 – Research framework for reinforcement learning prototyping
* [OneFlow](https://github.com/Oneflow-Inc/oneflow) ⭐ 9,432 | 🐛 645 | 🌐 C++ | 📅 2025-12-04 – Performance-centered open-source deep learning framework
* [BentoML](https://github.com/bentoml/BentoML) ⭐ 8,835 | 🐛 217 | 🌐 Python | 📅 2026-09-07 – Open-source framework for high-performance ML model serving
* [flashlight](https://github.com/facebookresearch/flashlight) ⭐ 5,468 | 🐛 126 | 🌐 C++ | 📅 2026-06-22 – C++ standalone library for machine learning
* [SynapseML](https://github.com/microsoft/SynapseML) ⭐ 5,246 | 🐛 147 | 🌐 Scala | 📅 2026-09-10 – Scalable ML pipelines on Apache Spark
...
* [Polyaxon](https://github.com/polyaxon/polyaxon) ⭐ 3,729 | 🐛 125 | 🌐 MDX | 📅 2026-09-12 – ML platform for Kubernetes training and monitoring
