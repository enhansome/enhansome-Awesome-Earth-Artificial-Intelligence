...
* [Fundamentals of ML and DL in Python](https://github.com/ageron/handson-ml) ⭐ 25,598 | 🐛 145 | 🌐 Jupyter Notebook | 📅 2026-05-19 - A series of Jupyter notebooks that walk you through the fundamentals of Machine Learning and Deep Learning in python using Scikit-Learn and TensorFlow.

* [Stanford CS 229 ML Cheatsheets](https://github.com/afshinea/stanford-cs-229-machine-learning) ⭐ 20,164 | 🐛 20 | 📅 2020-05-20
...
* :sunglasses: [TorchGeo](https://github.com/torchgeo/torchgeo) ⭐ 4,162 | 🐛 209 | 🌐 Python | 📅 2026-08-28 [docs](https://torchgeo.readthedocs.io/) - PyTorch domain library with 100+ geospatial datasets, spatial samplers, multispectral transforms, and pretrained backbones
...
* :sunglasses: [TerraTorch](https://github.com/IBM/terratorch) ⭐ 852 | 🐛 49 | 🌐 Python | 📅 2026-08-28 [paper](https://arxiv.org/abs/2503.20563) - Fine-tuning and benchmarking toolkit for geospatial foundation models; integrates with GEO-Bench-2 and Hugging Face weights

* [torch-harmonics](https://github.com/NVIDIA/torch-harmonics) ⭐ 697 | 🐛 6 | 🌐 Jupyter Notebook | 📅 2026-08-28 - Differentiable signal processing on the sphere for geometric weather ML; BSD-3-Clause
...
* [GRIME AI](https://github.com/GRIME-Lab/GRIME-AI/wiki) ⭐ 4 | 🐛 0 | 🌐 Python | 📅 2026-08-28 [website](https://gaugecam.org/) - Ecohydrological workflow suite for ground-based time-lapse imagery, from acquisition through ML applications
...
* [GraphCast / GenCast](https://github.com/google-deepmind/graphcast) ⭐ 7,605 | 🐛 77 | 🌐 Python | 📅 2026-08-11 [GraphCast paper](https://arxiv.org/abs/2212.12794) [GenCast paper](https://arxiv.org/abs/2312.15796) - GNN-based medium-range global weather forecasting and diffusion ensemble forecasting; Apache 2.0
...
* [Awesome Machine Learning](https://github.com/josephmisiti/awesome-machine-learning) ⭐ 74,202 | 🐛 29 | 🌐 Python | 📅 2026-08-27 - ![Awesome](media/icon/awesome.png) A curated list of awesome Machine Learning frameworks, libraries and software
...
* [Awesome-Open-Geoscience](https://github.com/softwareunderground/awesome-open-geoscience) ⭐ 1,825 | 🐛 11 | 📅 2026-05-26 – ![Awesome](media/icon/awesome.png) A list is curated from repositories that make our lives as geoscientists, hackers and data wranglers easier or just more awesome. In accordance with the awesome manifesto, we add awesome repositories.
...
* [MindsDB](https://github.com/mindsdb/mindsdb) ⭐ 39,656 | 🐛 2 | 🌐 Makefile | 📅 2026-08-21 – Explainable AutoML framework on PyTorch
* [Netron](https://github.com/lutzroeder/netron) ⭐ 33,420 | 🐛 18 | 🌐 JavaScript | 📅 2026-08-28 – Neural network and ONNX/Keras/TFLite model visualizer
* [MLflow](https://github.com/mlflow/mlflow) ⭐ 27,713 | 🐛 2,057 | 🌐 Python | 📅 2026-08-28 – Machine learning lifecycle platform
...
* [SynapseML](https://github.com/microsoft/SynapseML) ⭐ 5,242 | 🐛 141 | 🌐 Scala | 📅 2026-08-28 – Scalable ML pipelines on Apache Spark
...
* [Polyaxon](https://github.com/polyaxon/polyaxon) ⭐ 3,726 | 🐛 126 | 🌐 MDX | 📅 2026-08-28 – ML platform for Kubernetes training and monitoring
