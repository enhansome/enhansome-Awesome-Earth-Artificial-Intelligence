...
* [Fundamentals of ML and DL in Python](https://github.com/ageron/handson-ml) ⭐ 25,600 | 🐛 145 | 🌐 Jupyter Notebook | 📅 2026-05-19 - A series of Jupyter notebooks that walk you through the fundamentals of Machine Learning and Deep Learning in python using Scikit-Learn and TensorFlow.

* [Stanford CS 229 ML Cheatsheets](https://github.com/afshinea/stanford-cs-229-machine-learning) ⭐ 20,186 | 🐛 20 | 📅 2020-05-20
...
* :sunglasses: [TorchGeo](https://github.com/torchgeo/torchgeo) ⭐ 4,171 | 🐛 212 | 🌐 Python | 📅 2026-09-03 [docs](https://torchgeo.readthedocs.io/) - PyTorch domain library with 100+ geospatial datasets, spatial samplers, multispectral transforms, and pretrained backbones

* [segment-geospatial (samgeo)](https://github.com/opengeos/segment-geospatial) ⭐ 4,133 | 🐛 6 | 🌐 Python | 📅 2026-08-31 [docs](https://samgeo.gishub.org/) - Segment Anything Model (SAM) and HQ-SAM for geospatial imagery segmentation

* :sunglasses: [GeoAI](https://github.com/opengeos/geoai) ⭐ 3,347 | 🐛 8 | 🌐 Python | 📅 2026-08-31 [docs](https://opengeoai.org/) - Unified Python framework for EO deep learning: segmentation, detection, change detection, and foundation model workflows
...
* :sunglasses: [TerraTorch](https://github.com/IBM/terratorch) ⭐ 854 | 🐛 49 | 🌐 Python | 📅 2026-08-31 [paper](https://arxiv.org/abs/2503.20563) - Fine-tuning and benchmarking toolkit for geospatial foundation models; integrates with GEO-Bench-2 and Hugging Face weights

* [torch-harmonics](https://github.com/NVIDIA/torch-harmonics) ⭐ 698 | 🐛 7 | 🌐 Jupyter Notebook | 📅 2026-09-03 - Differentiable signal processing on the sphere for geometric weather ML; BSD-3-Clause

* [WeatherBench 2](https://github.com/google-research/weatherbench2) ⭐ 633 | 🐛 86 | 🌐 Python | 📅 2026-08-01 [docs](https://weatherbench2.readthedocs.io/) - Open evaluation framework and leaderboard for data-driven global weather models

* [ai-models](https://github.com/ecmwf-lab/ai-models) ⭐ 588 | 🐛 7 | 🌐 Python | 📅 2026-08-06 - Open-source CLI to run AI weather models (GraphCast, FourCastNet, Pangu-Weather) with ECMWF data pipelines
...
* [Makani](https://github.com/NVIDIA/makani) ⭐ 397 | 🐛 3 | 🌐 Python | 📅 2026-09-03 - Scalable training framework for ML weather models (FourCastNet 3); Apache 2.0
...
* [AI Segmentation by TerraLab](https://github.com/TerraLabAI/QGIS_AI-Segmentation) ⭐ 38 | 🐛 0 | 🌐 Python | 📅 2026-09-02 - QGIS plugin for point-and-click segmentation of buildings, trees and any object in satellite and drone imagery into vector polygons, with a free CPU-only local mode
...
* :sunglasses::sparkling\_heart: [Clay](https://github.com/Clay-foundation/model) ⭐ 612 | 🐛 40 | 🌐 Python | 📅 2026-05-11 [docs](https://clay-foundation.github.io/model/) [weights](https://huggingface.co/made-with-clay/Clay) - Sensor-agnostic MAE foundation model (v1.5) for EO embeddings across Sentinel-2, Landsat, Sentinel-1, and custom sensors; Apache 2.0

* [TerraMind](https://github.com/ibm/terramind) ⭐ 317 | 🐛 16 | 🌐 Jupyter Notebook | 📅 2026-08-31 [weights](https://huggingface.co/ibm-esa-geospatial) [paper](https://arxiv.org/abs/2504.11171) - Any-to-any generative multimodal EO foundation model (IBM/ESA Φ-lab); fine-tune via [TerraTorch](#tools)

* :sunglasses::sparkling\_heart: [Prithvi-EO-2.0](https://github.com/NASA-IMPACT/Prithvi-EO-2.0) ⭐ 304 | 🐛 10 | 📅 2025-02-13 [weights](https://huggingface.co/ibm-nasa-geospatial) [paper](https://arxiv.org/abs/2412.02732) - Multi-temporal ViT foundation model (300M/600M) trained on 4.2M global HLS time series at 30 m; fine-tune via [TerraTorch](#tools)

* [DOFA](https://github.com/zhu-xlab/DOFA) ⭐ 209 | 🐛 6 | 🌐 Jupyter Notebook | 📅 2026-07-22 [paper](https://arxiv.org/abs/2403.15356) - Dynamic One-For-All multimodal foundation model with wavelength-conditioned hypernetworks for cross-sensor generalization
...
* [GraphCast / GenCast](https://github.com/google-deepmind/graphcast) ⭐ 7,615 | 🐛 77 | 🌐 Python | 📅 2026-08-11 [GraphCast paper](https://arxiv.org/abs/2212.12794) [GenCast paper](https://arxiv.org/abs/2312.15796) - GNN-based medium-range global weather forecasting and diffusion ensemble forecasting; Apache 2.0

* [Aurora](https://github.com/microsoft/aurora) ⭐ 1,015 | 🐛 69 | 🌐 Python | 📅 2026-08-19 [docs](https://microsoft.github.io/aurora/) [paper](https://arxiv.org/abs/2405.13063) - 1.3B-parameter atmospheric foundation model for weather, air pollution, and ocean waves

* [NeuralGCM](https://github.com/neuralgcm/neuralgcm) ⭐ 1,011 | 🐛 67 | 🌐 Python | 📅 2026-07-14 [dycore](https://github.com/neuralgcm/dinosaur) ⭐ 334 | 🐛 7 | 🌐 Jupyter Notebook | 📅 2026-09-03 [paper](https://arxiv.org/abs/2311.07222) - Differentiable hybrid general circulation model combining physics-based dynamics with learned components; Apache 2.0 code, CC BY-SA 4.0 weights
...
* [WeatherBench 2 ERA5 Zarr](https://github.com/google-research/weatherbench2) ⭐ 633 | 🐛 86 | 🌐 Python | 📅 2026-08-01 - Open cloud-optimized ERA5 and baseline forecast data for ML weather model training and evaluation
...
* [GeoChat](https://github.com/mbzuai-oryx/GeoChat) ⭐ 748 | 🐛 47 | 🌐 Python | 📅 2024-11-28 [paper](https://arxiv.org/abs/2311.15826) - Grounded large vision-language model for remote sensing QA, captioning, and referring detection
...
* [TEOChat](https://github.com/ermongroup/TEOChat) ⭐ 151 | 🐛 7 | 🌐 Python | 📅 2025-12-01 [paper](https://arxiv.org/abs/2410.06234) - Temporal vision-language assistant for change detection, damage assessment, and EO dialogue
...
* [Awesome Machine Learning](https://github.com/josephmisiti/awesome-machine-learning) ⭐ 74,246 | 🐛 29 | 🌐 Python | 📅 2026-09-02 - ![Awesome](media/icon/awesome.png) A curated list of awesome Machine Learning frameworks, libraries and software
...
* [Awesome Pipeline](https://github.com/pditommaso/awesome-pipeline) ⭐ 6,625 | 🐛 35 | 📅 2026-08-04 - ![Awesome](media/icon/awesome.png) A curated list of awesome pipeline toolkits inspired by Awesome Sysadmin
...
* [Awesome-Open-Geoscience](https://github.com/softwareunderground/awesome-open-geoscience) ⭐ 1,831 | 🐛 12 | 📅 2026-05-26 – ![Awesome](media/icon/awesome.png) A list is curated from repositories that make our lives as geoscientists, hackers and data wranglers easier or just more awesome. In accordance with the awesome manifesto, we add awesome repositories.
...
* [MindsDB](https://github.com/mindsdb/mindsdb) ⭐ 39,688 | 🐛 5 | 🌐 Makefile | 📅 2026-09-02 – Explainable AutoML framework on PyTorch
* [Netron](https://github.com/lutzroeder/netron) ⭐ 33,434 | 🐛 18 | 🌐 JavaScript | 📅 2026-09-03 – Neural network and ONNX/Keras/TFLite model visualizer
* [MLflow](https://github.com/mlflow/mlflow) ⭐ 27,795 | 🐛 2,060 | 🌐 Python | 📅 2026-09-03 – Machine learning lifecycle platform
...
* [BentoML](https://github.com/bentoml/BentoML) ⭐ 8,820 | 🐛 212 | 🌐 Python | 📅 2026-08-28 – Open-source framework for high-performance ML model serving
* [flashlight](https://github.com/facebookresearch/flashlight) ⭐ 5,468 | 🐛 126 | 🌐 C++ | 📅 2026-06-22 – C++ standalone library for machine learning
* [SynapseML](https://github.com/microsoft/SynapseML) ⭐ 5,246 | 🐛 142 | 🌐 Scala | 📅 2026-09-02 – Scalable ML pipelines on Apache Spark
...
* [Polyaxon](https://github.com/polyaxon/polyaxon) ⭐ 3,728 | 🐛 126 | 🌐 MDX | 📅 2026-09-03 – ML platform for Kubernetes training and monitoring
