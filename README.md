...
* [Stanford CS 229 ML Cheatsheets](https://github.com/afshinea/stanford-cs-229-machine-learning) ⭐ 20,207 | 🐛 20 | 📅 2020-05-20
...
* :sunglasses: [TorchGeo](https://github.com/torchgeo/torchgeo) ⭐ 4,178 | 🐛 219 | 🌐 Python | 📅 2026-09-09 [docs](https://torchgeo.readthedocs.io/) - PyTorch domain library with 100+ geospatial datasets, spatial samplers, multispectral transforms, and pretrained backbones
...
* :sunglasses: [GeoAI](https://github.com/opengeos/geoai) ⭐ 3,366 | 🐛 9 | 🌐 Python | 📅 2026-09-07 [docs](https://opengeoai.org/) - Unified Python framework for EO deep learning: segmentation, detection, change detection, and foundation model workflows
...
* [torch-harmonics](https://github.com/NVIDIA/torch-harmonics) ⭐ 701 | 🐛 11 | 🌐 Jupyter Notebook | 📅 2026-09-11 - Differentiable signal processing on the sphere for geometric weather ML; BSD-3-Clause
...
* [TerraMind](https://github.com/ibm/terramind) ⭐ 319 | 🐛 16 | 🌐 Jupyter Notebook | 📅 2026-09-07 [weights](https://huggingface.co/ibm-esa-geospatial) [paper](https://arxiv.org/abs/2504.11171) - Any-to-any generative multimodal EO foundation model (IBM/ESA Φ-lab); fine-tune via [TerraTorch](#tools)
...
* [GraphCast / GenCast](https://github.com/google-deepmind/graphcast) ⭐ 7,662 | 🐛 78 | 🌐 Python | 📅 2026-09-04 [GraphCast paper](https://arxiv.org/abs/2212.12794) [GenCast paper](https://arxiv.org/abs/2312.15796) - GNN-based medium-range global weather forecasting and diffusion ensemble forecasting; Apache 2.0
...
* [EuroSAT Dataset](https://github.com/phelber/EuroSAT) ⭐ 576 | 🐛 0 | 📅 2023-03-09 - EuroSAT Dataset: Land Use and Land Cover Classification with Sentinel-2,
...
* [Awesome Machine Learning](https://github.com/josephmisiti/awesome-machine-learning) ⭐ 74,321 | 🐛 29 | 🌐 Python | 📅 2026-09-12 - ![Awesome](media/icon/awesome.png) A curated list of awesome Machine Learning frameworks, libraries and software
...
* [Awesome-Open-Geoscience](https://github.com/softwareunderground/awesome-open-geoscience) ⭐ 1,841 | 🐛 12 | 📅 2026-05-26 – ![Awesome](media/icon/awesome.png) A list is curated from repositories that make our lives as geoscientists, hackers and data wranglers easier or just more awesome. In accordance with the awesome manifesto, we add awesome repositories.
...
* [MindsDB](https://github.com/mindsdb/mindsdb) ⭐ 39,733 | 🐛 5 | 🌐 Makefile | 📅 2026-09-11 – Explainable AutoML framework on PyTorch
* [Netron](https://github.com/lutzroeder/netron) ⭐ 33,478 | 🐛 18 | 🌐 JavaScript | 📅 2026-09-12 – Neural network and ONNX/Keras/TFLite model visualizer
* [MLflow](https://github.com/mlflow/mlflow) ⭐ 27,934 | 🐛 2,097 | 🌐 Python | 📅 2026-09-13 – Machine learning lifecycle platform
...
* [BentoML](https://github.com/bentoml/BentoML) ⭐ 8,838 | 🐛 217 | 🌐 Python | 📅 2026-09-07 – Open-source framework for high-performance ML model serving
...
* [Polyaxon](https://github.com/polyaxon/polyaxon) ⭐ 3,730 | 🐛 125 | 🌐 MDX | 📅 2026-09-12 – ML platform for Kubernetes training and monitoring
