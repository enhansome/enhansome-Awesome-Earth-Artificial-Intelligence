...
* [Stanford CS 229 ML Cheatsheets](https://github.com/afshinea/stanford-cs-229-machine-learning) ⭐ 20,132 | 🐛 20 | 📅 2020-05-20
...
* :sunglasses: [TorchGeo](https://github.com/torchgeo/torchgeo) ⭐ 4,153 | 🐛 191 | 🌐 Python | 📅 2026-08-19 [docs](https://torchgeo.readthedocs.io/) - PyTorch domain library with 100+ geospatial datasets, spatial samplers, multispectral transforms, and pretrained backbones

* [segment-geospatial (samgeo)](https://github.com/opengeos/segment-geospatial) ⭐ 4,116 | 🐛 6 | 🌐 Python | 📅 2026-08-17 [docs](https://samgeo.gishub.org/) - Segment Anything Model (SAM) and HQ-SAM for geospatial imagery segmentation

* :sunglasses: [GeoAI](https://github.com/opengeos/geoai) ⭐ 3,306 | 🐛 5 | 🌐 Python | 📅 2026-08-17 [docs](https://opengeoai.org/) - Unified Python framework for EO deep learning: segmentation, detection, change detection, and foundation model workflows
...
* [torch-harmonics](https://github.com/NVIDIA/torch-harmonics) ⭐ 697 | 🐛 7 | 🌐 Jupyter Notebook | 📅 2026-08-19 - Differentiable signal processing on the sphere for geometric weather ML; BSD-3-Clause
...
* [Makani](https://github.com/NVIDIA/makani) ⭐ 398 | 🐛 3 | 🌐 Python | 📅 2026-08-20 - Scalable training framework for ML weather models (FourCastNet 3); Apache 2.0
...
* [Copernicus-FM](https://github.com/zhu-xlab/Copernicus-FM) ⭐ 148 | 🐛 4 | 🌐 Jupyter Notebook | 📅 2025-10-02 [paper](https://arxiv.org/abs/2503.11849) - Unified Copernicus foundation model across Sentinel missions with Copernicus-Pretrain and Copernicus-Bench
...
* [GraphCast / GenCast](https://github.com/google-deepmind/graphcast) ⭐ 7,566 | 🐛 77 | 🌐 Python | 📅 2026-08-11 [GraphCast paper](https://arxiv.org/abs/2212.12794) [GenCast paper](https://arxiv.org/abs/2312.15796) - GNN-based medium-range global weather forecasting and diffusion ensemble forecasting; Apache 2.0
...
* [Aurora](https://github.com/microsoft/aurora) ⭐ 1,004 | 🐛 69 | 🌐 Python | 📅 2026-08-19 [docs](https://microsoft.github.io/aurora/) [paper](https://arxiv.org/abs/2405.13063) - 1.3B-parameter atmospheric foundation model for weather, air pollution, and ocean waves
...
* [Copernicus-Embed-025deg](https://github.com/zhu-xlab/Copernicus-FM) ⭐ 148 | 🐛 4 | 🌐 Jupyter Notebook | 📅 2025-10-02 - Global 0.25° embedding map integrating multi-source Sentinel observations (released with Copernicus-FM)
...
* [GeoChat](https://github.com/mbzuai-oryx/GeoChat) ⭐ 742 | 🐛 47 | 🌐 Python | 📅 2024-11-28 [paper](https://arxiv.org/abs/2311.15826) - Grounded large vision-language model for remote sensing QA, captioning, and referring detection
...
* [Awesome Machine Learning](https://github.com/josephmisiti/awesome-machine-learning) ⭐ 74,080 | 🐛 26 | 🌐 Python | 📅 2026-08-11 - ![Awesome](media/icon/awesome.png) A curated list of awesome Machine Learning frameworks, libraries and software
* [Awesome Workflow Engines](https://github.com/meirwah/awesome-workflow-engines) ⭐ 7,916 | 🐛 69 | 📅 2026-04-06 - ![Awesome](media/icon/awesome.png) A curated list of awesome open source workflow engines
...
* [Awesome-Open-Geoscience](https://github.com/softwareunderground/awesome-open-geoscience) ⭐ 1,816 | 🐛 10 | 📅 2026-05-26 – ![Awesome](media/icon/awesome.png) A list is curated from repositories that make our lives as geoscientists, hackers and data wranglers easier or just more awesome. In accordance with the awesome manifesto, we add awesome repositories.
...
* [MindsDB](https://github.com/mindsdb/mindsdb) ⭐ 39,613 | 🐛 3 | 🌐 Makefile | 📅 2026-08-20 – Explainable AutoML framework on PyTorch
* [Netron](https://github.com/lutzroeder/netron) ⭐ 33,369 | 🐛 16 | 🌐 JavaScript | 📅 2026-08-18 – Neural network and ONNX/Keras/TFLite model visualizer
* [MLflow](https://github.com/mlflow/mlflow) ⭐ 27,593 | 🐛 2,056 | 🌐 Python | 📅 2026-08-20 – Machine learning lifecycle platform
...
* [SynapseML](https://github.com/microsoft/SynapseML) ⭐ 5,238 | 🐛 146 | 🌐 Scala | 📅 2026-08-20 – Scalable ML pipelines on Apache Spark
...
* [Polyaxon](https://github.com/polyaxon/polyaxon) ⭐ 3,720 | 🐛 126 | 🌐 MDX | 📅 2026-08-17 – ML platform for Kubernetes training and monitoring
