...
* [Stanford CS 229 ML Cheatsheets](https://github.com/afshinea/stanford-cs-229-machine-learning) ⭐ 20,176 | 🐛 20 | 📅 2020-05-20
...
* :sunglasses: [TorchGeo](https://github.com/torchgeo/torchgeo) ⭐ 4,164 | 🐛 209 | 🌐 Python | 📅 2026-08-31 [docs](https://torchgeo.readthedocs.io/) - PyTorch domain library with 100+ geospatial datasets, spatial samplers, multispectral transforms, and pretrained backbones
...
* :sunglasses: [GeoAI](https://github.com/opengeos/geoai) ⭐ 3,341 | 🐛 8 | 🌐 Python | 📅 2026-08-31 [docs](https://opengeoai.org/) - Unified Python framework for EO deep learning: segmentation, detection, change detection, and foundation model workflows
...
* :sunglasses: [TerraTorch](https://github.com/IBM/terratorch) ⭐ 853 | 🐛 48 | 🌐 Python | 📅 2026-08-31 [paper](https://arxiv.org/abs/2503.20563) - Fine-tuning and benchmarking toolkit for geospatial foundation models; integrates with GEO-Bench-2 and Hugging Face weights

* [torch-harmonics](https://github.com/NVIDIA/torch-harmonics) ⭐ 696 | 🐛 7 | 🌐 Jupyter Notebook | 📅 2026-09-01 - Differentiable signal processing on the sphere for geometric weather ML; BSD-3-Clause
...
* [ai-models](https://github.com/ecmwf-lab/ai-models) ⭐ 587 | 🐛 7 | 🌐 Python | 📅 2026-08-06 - Open-source CLI to run AI weather models (GraphCast, FourCastNet, Pangu-Weather) with ECMWF data pipelines
...
* [Makani](https://github.com/NVIDIA/makani) ⭐ 397 | 🐛 2 | 🌐 Python | 📅 2026-08-31 - Scalable training framework for ML weather models (FourCastNet 3); Apache 2.0
...
* [AI Segmentation by TerraLab](https://github.com/TerraLabAI/QGIS_AI-Segmentation) ⭐ 36 | 🐛 0 | 🌐 Python | 📅 2026-08-28 - QGIS plugin for point-and-click segmentation of buildings, trees and any object in satellite and drone imagery into vector polygons, with a free CPU-only local mode
...
* :sunglasses::sparkling\_heart: [Clay](https://github.com/Clay-foundation/model) ⭐ 611 | 🐛 40 | 🌐 Python | 📅 2026-05-11 [docs](https://clay-foundation.github.io/model/) [weights](https://huggingface.co/made-with-clay/Clay) - Sensor-agnostic MAE foundation model (v1.5) for EO embeddings across Sentinel-2, Landsat, Sentinel-1, and custom sensors; Apache 2.0
...
* [GraphCast / GenCast](https://github.com/google-deepmind/graphcast) ⭐ 7,608 | 🐛 77 | 🌐 Python | 📅 2026-08-11 [GraphCast paper](https://arxiv.org/abs/2212.12794) [GenCast paper](https://arxiv.org/abs/2312.15796) - GNN-based medium-range global weather forecasting and diffusion ensemble forecasting; Apache 2.0
...
* [NeuralGCM](https://github.com/neuralgcm/neuralgcm) ⭐ 1,010 | 🐛 67 | 🌐 Python | 📅 2026-07-14 [dycore](https://github.com/neuralgcm/dinosaur) ⭐ 333 | 🐛 8 | 🌐 Jupyter Notebook | 📅 2026-09-01 [paper](https://arxiv.org/abs/2311.07222) - Differentiable hybrid general circulation model combining physics-based dynamics with learned components; Apache 2.0 code, CC BY-SA 4.0 weights
...
* [GeoChat](https://github.com/mbzuai-oryx/GeoChat) ⭐ 745 | 🐛 47 | 🌐 Python | 📅 2024-11-28 [paper](https://arxiv.org/abs/2311.15826) - Grounded large vision-language model for remote sensing QA, captioning, and referring detection
...
* [EarthDial](https://github.com/hiyamdebary/EarthDial) ⭐ 140 | 🐛 10 | 🌐 Python | 📅 2025-06-20 [paper](https://arxiv.org/abs/2412.15190) - Multi-spectral, multi-temporal vision-language model for EO dialogue across 44 downstream datasets
...
* [Awesome Machine Learning](https://github.com/josephmisiti/awesome-machine-learning) ⭐ 74,237 | 🐛 30 | 🌐 Python | 📅 2026-08-27 - ![Awesome](media/icon/awesome.png) A curated list of awesome Machine Learning frameworks, libraries and software
* [Awesome Workflow Engines](https://github.com/meirwah/awesome-workflow-engines) ⭐ 7,919 | 🐛 71 | 📅 2026-04-06 - ![Awesome](media/icon/awesome.png) A curated list of awesome open source workflow engines
* [Awesome Pipeline](https://github.com/pditommaso/awesome-pipeline) ⭐ 6,624 | 🐛 34 | 📅 2026-08-04 - ![Awesome](media/icon/awesome.png) A curated list of awesome pipeline toolkits inspired by Awesome Sysadmin
...
* [Awesome-Open-Geoscience](https://github.com/softwareunderground/awesome-open-geoscience) ⭐ 1,829 | 🐛 11 | 📅 2026-05-26 – ![Awesome](media/icon/awesome.png) A list is curated from repositories that make our lives as geoscientists, hackers and data wranglers easier or just more awesome. In accordance with the awesome manifesto, we add awesome repositories.
...
* [MindsDB](https://github.com/mindsdb/mindsdb) ⭐ 39,676 | 🐛 3 | 🌐 Makefile | 📅 2026-08-21 – Explainable AutoML framework on PyTorch
* [Netron](https://github.com/lutzroeder/netron) ⭐ 33,432 | 🐛 19 | 🌐 JavaScript | 📅 2026-09-01 – Neural network and ONNX/Keras/TFLite model visualizer
* [MLflow](https://github.com/mlflow/mlflow) ⭐ 27,766 | 🐛 2,053 | 🌐 Python | 📅 2026-09-01 – Machine learning lifecycle platform
* [Dopamine](https://github.com/google/dopamine) ⭐ 10,905 | 🐛 111 | 🌐 Jupyter Notebook | 📅 2026-03-24 – Research framework for reinforcement learning prototyping
...
* [BentoML](https://github.com/bentoml/BentoML) ⭐ 8,816 | 🐛 212 | 🌐 Python | 📅 2026-08-28 – Open-source framework for high-performance ML model serving
* [flashlight](https://github.com/facebookresearch/flashlight) ⭐ 5,469 | 🐛 126 | 🌐 C++ | 📅 2026-06-22 – C++ standalone library for machine learning
* [SynapseML](https://github.com/microsoft/SynapseML) ⭐ 5,242 | 🐛 141 | 🌐 Scala | 📅 2026-08-31 – Scalable ML pipelines on Apache Spark
...
* [ml.js](https://github.com/mljs/ml) ⭐ 2,718 | 🐛 27 | 🌐 JavaScript | 📅 2024-10-21 – Machine learning tools in JavaScript
