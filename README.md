...
* [Fundamentals of ML and DL in Python](https://github.com/ageron/handson-ml) ⭐ 25,607 | 🐛 145 | 🌐 Jupyter Notebook | 📅 2026-05-19 - A series of Jupyter notebooks that walk you through the fundamentals of Machine Learning and Deep Learning in python using Scikit-Learn and TensorFlow.

* [Stanford CS 229 ML Cheatsheets](https://github.com/afshinea/stanford-cs-229-machine-learning) ⭐ 20,085 | 🐛 20 | 📅 2020-05-20
...
* [RadiantEarth ML4EO Bootcamp 2021](https://github.com/RadiantMLHub/ml4eo-bootcamp-2021) ⭐ 102 | 🐛 0 | 🌐 Jupyter Notebook | 📅 2021-11-17

* :sunglasses::sparkling\_heart: [GeoAI with Python: A Practical Guide to Open-Source Geospatial AI](https://github.com/giswqs/GeoAI-Book) ⭐ 43 | 🐛 2 | 🌐 Jupyter Notebook | 📅 2026-07-20 [Zenodo](https://zenodo.org/records/19207014) - Open-access book with 23 chapters of executable code for segmentation, detection, change detection, and foundation models
...
* :sunglasses: [TorchGeo](https://github.com/torchgeo/torchgeo) ⭐ 4,142 | 🐛 189 | 🌐 Python | 📅 2026-08-13 [docs](https://torchgeo.readthedocs.io/) - PyTorch domain library with 100+ geospatial datasets, spatial samplers, multispectral transforms, and pretrained backbones

* [segment-geospatial (samgeo)](https://github.com/opengeos/segment-geospatial) ⭐ 4,108 | 🐛 6 | 🌐 Python | 📅 2026-08-10 [docs](https://samgeo.gishub.org/) - Segment Anything Model (SAM) and HQ-SAM for geospatial imagery segmentation

* :sunglasses: [GeoAI](https://github.com/opengeos/geoai) ⭐ 3,268 | 🐛 3 | 🌐 Python | 📅 2026-08-10 [docs](https://opengeoai.org/) - Unified Python framework for EO deep learning: segmentation, detection, change detection, and foundation model workflows

* [eo-learn](https://github.com/sentinel-hub/eo-learn) ⭐ 1,243 | 🐛 7 | 🌐 Python | 📅 2026-01-15 - Earth observation processing framework for machine learning in Python

* :sunglasses: [TerraTorch](https://github.com/IBM/terratorch) ⭐ 843 | 🐛 41 | 🌐 Python | 📅 2026-08-13 [paper](https://arxiv.org/abs/2503.20563) - Fine-tuning and benchmarking toolkit for geospatial foundation models; integrates with GEO-Bench-2 and Hugging Face weights

* [torch-harmonics](https://github.com/NVIDIA/torch-harmonics) ⭐ 693 | 🐛 6 | 🌐 Jupyter Notebook | 📅 2026-08-13 - Differentiable signal processing on the sphere for geometric weather ML; BSD-3-Clause

* [WeatherBench 2](https://github.com/google-research/weatherbench2) ⭐ 630 | 🐛 85 | 🌐 Python | 📅 2026-08-01 [docs](https://weatherbench2.readthedocs.io/) - Open evaluation framework and leaderboard for data-driven global weather models

* [ai-models](https://github.com/ecmwf-lab/ai-models) ⭐ 584 | 🐛 7 | 🌐 Python | 📅 2026-08-06 - Open-source CLI to run AI weather models (GraphCast, FourCastNet, Pangu-Weather) with ECMWF data pipelines

* [SeisBench](https://github.com/seisbench/seisbench) ⭐ 412 | 🐛 20 | 🌐 Jupyter Notebook | 📅 2026-07-28 [docs](https://seisbench.readthedocs.io/) - Open toolbox for earthquake ML: phase picking, event detection, pretrained models, and benchmark datasets

* [Makani](https://github.com/NVIDIA/makani) ⭐ 398 | 🐛 2 | 🌐 Python | 📅 2026-08-11 - Scalable training framework for ML weather models (FourCastNet 3); Apache 2.0
...
* [GEO-Bench-2](https://github.com/The-AI-Alliance/GEO-Bench-2) ⭐ 30 | 🐛 12 | 🌐 Python | 📅 2026-07-20 [leaderboard](https://huggingface.co/spaces/aialliance/GEO-Bench-2-Leaderboard) [paper](https://arxiv.org/abs/2511.15658) - Reproducible benchmark for geospatial foundation models across 19 permissively licensed datasets

* :sunglasses: [pygeoweaver](https://github.com/ESIPFed/pygeoweaver) ⭐ 17 | 🐛 11 | 🌐 Python | 📅 2026-06-08 - Python library for AI & geospatial workflow management, FAIRness, tangibility and productivity improvement
...
* [GRIME AI](https://github.com/GRIME-Lab/GRIME-AI/wiki) ⭐ 4 | 🐛 0 | 🌐 Python | 📅 2026-08-11 [website](https://gaugecam.org/) - Ecohydrological workflow suite for ground-based time-lapse imagery, from acquisition through ML applications
...
* :sunglasses::sparkling\_heart: [Clay](https://github.com/Clay-foundation/model) ⭐ 605 | 🐛 40 | 🌐 Python | 📅 2026-05-11 [docs](https://clay-foundation.github.io/model/) [weights](https://huggingface.co/made-with-clay/Clay) - Sensor-agnostic MAE foundation model (v1.5) for EO embeddings across Sentinel-2, Landsat, Sentinel-1, and custom sensors; Apache 2.0

* [TerraMind](https://github.com/ibm/terramind) ⭐ 298 | 🐛 17 | 🌐 Jupyter Notebook | 📅 2026-08-10 [weights](https://huggingface.co/ibm-esa-geospatial) [paper](https://arxiv.org/abs/2504.11171) - Any-to-any generative multimodal EO foundation model (IBM/ESA Φ-lab); fine-tune via [TerraTorch](#tools)

* :sunglasses::sparkling\_heart: [Prithvi-EO-2.0](https://github.com/NASA-IMPACT/Prithvi-EO-2.0) ⭐ 292 | 🐛 10 | 📅 2025-02-13 [weights](https://huggingface.co/ibm-nasa-geospatial) [paper](https://arxiv.org/abs/2412.02732) - Multi-temporal ViT foundation model (300M/600M) trained on 4.2M global HLS time series at 30 m; fine-tune via [TerraTorch](#tools)

* [DOFA](https://github.com/zhu-xlab/DOFA) ⭐ 204 | 🐛 6 | 🌐 Jupyter Notebook | 📅 2026-07-22 [paper](https://arxiv.org/abs/2403.15356) - Dynamic One-For-All multimodal foundation model with wavelength-conditioned hypernetworks for cross-sensor generalization

* [Copernicus-FM](https://github.com/zhu-xlab/Copernicus-FM) ⭐ 147 | 🐛 4 | 🌐 Jupyter Notebook | 📅 2025-10-02 [paper](https://arxiv.org/abs/2503.11849) - Unified Copernicus foundation model across Sentinel missions with Copernicus-Pretrain and Copernicus-Bench
...
* [GraphCast / GenCast](https://github.com/google-deepmind/graphcast) ⭐ 7,482 | 🐛 77 | 🌐 Python | 📅 2026-08-11 [GraphCast paper](https://arxiv.org/abs/2212.12794) [GenCast paper](https://arxiv.org/abs/2312.15796) - GNN-based medium-range global weather forecasting and diffusion ensemble forecasting; Apache 2.0

* [NeuralGCM](https://github.com/neuralgcm/neuralgcm) ⭐ 1,006 | 🐛 67 | 🌐 Python | 📅 2026-07-14 [dycore](https://github.com/neuralgcm/dinosaur) ⭐ 334 | 🐛 8 | 🌐 Jupyter Notebook | 📅 2026-07-29 [paper](https://arxiv.org/abs/2311.07222) - Differentiable hybrid general circulation model combining physics-based dynamics with learned components; Apache 2.0 code, CC BY-SA 4.0 weights

* [Aurora](https://github.com/microsoft/aurora) ⭐ 997 | 🐛 69 | 🌐 Python | 📅 2026-08-04 [docs](https://microsoft.github.io/aurora/) [paper](https://arxiv.org/abs/2405.13063) - 1.3B-parameter atmospheric foundation model for weather, air pollution, and ocean waves
...
* [AI Cheatsheets](https://github.com/kailashahirwar/cheatsheets-ai) ⭐ 15,426 | 🐛 12 | 📅 2019-10-19 - Essential Cheat Sheets for deep learning and machine learning engineers. It contains a lot of useful tutorials to learn awesome tricks on AI engineering

* [Machine Learning Tutorials (general, not Earth science specific)](https://github.com/ethen8181/machine-learning) ⭐ 3,493 | 🐛 6 | 🌐 HTML | 📅 2026-07-10
...
* :sunglasses::sparkling\_heart: [GeoAI with Python Book Code](https://github.com/giswqs/GeoAI-Book) ⭐ 43 | 🐛 2 | 🌐 Jupyter Notebook | 📅 2026-07-20 - Executable notebooks for seven core GeoAI tasks and foundation model workflows
...
* [WeatherBench 2 ERA5 Zarr](https://github.com/google-research/weatherbench2) ⭐ 630 | 🐛 85 | 🌐 Python | 📅 2026-08-01 - Open cloud-optimized ERA5 and baseline forecast data for ML weather model training and evaluation

* [EuroSAT Dataset](https://github.com/phelber/EuroSAT) ⭐ 567 | 🐛 0 | 📅 2023-03-09 - EuroSAT Dataset: Land Use and Land Cover Classification with Sentinel-2,

* [STanford EArthquake Dataset (STEAD)](https://github.com/smousavi05/STEAD) ⭐ 402 | 🐛 3 | 🌐 Python | 📅 2023-07-07 - A Global Data Set of Seismic Signals for AI

* [Copernicus-Embed-025deg](https://github.com/zhu-xlab/Copernicus-FM) ⭐ 147 | 🐛 4 | 🌐 Jupyter Notebook | 📅 2025-10-02 - Global 0.25° embedding map integrating multi-source Sentinel observations (released with Copernicus-FM)

* [GEO-Bench-2 Datasets](https://github.com/The-AI-Alliance/GEO-Bench-2) ⭐ 30 | 🐛 12 | 🌐 Python | 📅 2026-07-20 - 19 permissively licensed benchmark datasets for geospatial foundation model evaluation on Hugging Face
...
* [GeoChat](https://github.com/mbzuai-oryx/GeoChat) ⭐ 738 | 🐛 47 | 🌐 Python | 📅 2024-11-28 [paper](https://arxiv.org/abs/2311.15826) - Grounded large vision-language model for remote sensing QA, captioning, and referring detection

* [EQTransformer](https://github.com/smousavi05/EQTransformer) ⭐ 415 | 🐛 43 | 🌐 Python | 📅 2026-04-13 - An AI-Based Earthquake Signal Detector and Phase Picker.
...
* [Continuous Change Detection and Classification](https://github.com/GERSL/CCDC) ⭐ 106 | 🐛 2 | 🌐 MATLAB | 📅 2024-10-30 - Continuous Change Detection and Classification (CCDC) of land cover using all available Landsat data,

* [Object-based Classification on Earth Engine](https://github.com/GERSL/CCDC) ⭐ 106 | 🐛 2 | 🌐 MATLAB | 📅 2024-10-30 - Object-based land cover classification with Feature Extraction and Feature Selection for Google Earth Engine (GEE),
...
* [Infernis](https://github.com/argonBIsystems/infernis) ⭐ 2 | 🐛 0 | 🌐 Python | 📅 2026-08-12 - Open-source ML-powered wildfire risk prediction engine for British Columbia. XGBoost + CNN trained on 10 fire seasons (2015-2024) from 21 open government and scientific data sources. Provides a free [REST API](https://infernis.ca/v1/docs) with daily predictions at 5km resolution.
...
* [Awesome Machine Learning](https://github.com/josephmisiti/awesome-machine-learning) ⭐ 74,015 | 🐛 25 | 🌐 Python | 📅 2026-08-11 - ![Awesome](media/icon/awesome.png) A curated list of awesome Machine Learning frameworks, libraries and software
* [Awesome Workflow Engines](https://github.com/meirwah/awesome-workflow-engines) ⭐ 7,911 | 🐛 68 | 📅 2026-04-06 - ![Awesome](media/icon/awesome.png) A curated list of awesome open source workflow engines
* [Awesome Pipeline](https://github.com/pditommaso/awesome-pipeline) ⭐ 6,618 | 🐛 34 | 📅 2026-08-04 - ![Awesome](media/icon/awesome.png) A curated list of awesome pipeline toolkits inspired by Awesome Sysadmin
...
* [Awesome-Open-Geoscience](https://github.com/softwareunderground/awesome-open-geoscience) ⭐ 1,812 | 🐛 10 | 📅 2026-05-26 – ![Awesome](media/icon/awesome.png) A list is curated from repositories that make our lives as geoscientists, hackers and data wranglers easier or just more awesome. In accordance with the awesome manifesto, we add awesome repositories.
...
* [Awesome-AI-for-Atmosphere-and-Ocean](https://github.com/XiongWeiTHU/Awesome-AI-for-Atmosphere-and-Ocean) ⭐ 39 | 🐛 0 | 📅 2023-10-04 – ![Awesome](media/icon/awesome.png) Research papers on AI for atmospheric science and oceanography
...
* [MindsDB](https://github.com/mindsdb/mindsdb) ⭐ 39,549 | 🐛 5 | 🌐 Makefile | 📅 2026-08-12 – Explainable AutoML framework on PyTorch
* [Netron](https://github.com/lutzroeder/netron) ⭐ 33,342 | 🐛 17 | 🌐 JavaScript | 📅 2026-08-12 – Neural network and ONNX/Keras/TFLite model visualizer
* [MLflow](https://github.com/mlflow/mlflow) ⭐ 27,498 | 🐛 2,018 | 🌐 Python | 📅 2026-08-13 – Machine learning lifecycle platform
* [Dopamine](https://github.com/google/dopamine) ⭐ 10,893 | 🐛 111 | 🌐 Jupyter Notebook | 📅 2026-03-24 – Research framework for reinforcement learning prototyping
* [OneFlow](https://github.com/Oneflow-Inc/oneflow) ⭐ 9,423 | 🐛 645 | 🌐 C++ | 📅 2025-12-04 – Performance-centered open-source deep learning framework
* [BentoML](https://github.com/bentoml/BentoML) ⭐ 8,784 | 🐛 202 | 🌐 Python | 📅 2026-08-03 – Open-source framework for high-performance ML model serving
* [flashlight](https://github.com/facebookresearch/flashlight) ⭐ 5,465 | 🐛 126 | 🌐 C++ | 📅 2026-06-22 – C++ standalone library for machine learning
* [SynapseML](https://github.com/microsoft/SynapseML) ⭐ 5,236 | 🐛 204 | 🌐 Scala | 📅 2026-08-13 – Scalable ML pipelines on Apache Spark
...
* [Polyaxon](https://github.com/polyaxon/polyaxon) ⭐ 3,718 | 🐛 126 | 🌐 MDX | 📅 2026-08-11 – ML platform for Kubernetes training and monitoring
* [TensorFlow Hub](https://github.com/tensorflow/hub) ⭐ 3,524 | 🐛 7 | 🌐 Python | 📅 2025-01-17 – Repository of reusable TensorFlow SavedModels
* [ml.js](https://github.com/mljs/ml) ⭐ 2,715 | 🐛 27 | 🌐 JavaScript | 📅 2024-10-21 – Machine learning tools in JavaScript
