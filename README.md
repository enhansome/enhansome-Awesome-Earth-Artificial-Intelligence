...
* [Stanford CS 229 ML Cheatsheets](https://github.com/afshinea/stanford-cs-229-machine-learning) ⭐ 20,244 | 🐛 21 | 📅 2020-05-20
...
* :sunglasses: [TorchGeo](https://github.com/torchgeo/torchgeo) ⭐ 4,190 | 🐛 212 | 🌐 Python | 📅 2026-09-23 [docs](https://torchgeo.readthedocs.io/) - PyTorch domain library with 100+ geospatial datasets, spatial samplers, multispectral transforms, and pretrained backbones

* [segment-geospatial (samgeo)](https://github.com/opengeos/segment-geospatial) ⭐ 4,147 | 🐛 8 | 🌐 Python | 📅 2026-09-21 [docs](https://samgeo.gishub.org/) - Segment Anything Model (SAM) and HQ-SAM for geospatial imagery segmentation

* :sunglasses: [GeoAI](https://github.com/opengeos/geoai) ⭐ 3,390 | 🐛 7 | 🌐 Python | 📅 2026-09-21 [docs](https://opengeoai.org/) - Unified Python framework for EO deep learning: segmentation, detection, change detection, and foundation model workflows
...
* :sunglasses: [TerraTorch](https://github.com/IBM/terratorch) ⭐ 864 | 🐛 51 | 🌐 Python | 📅 2026-09-17 [paper](https://arxiv.org/abs/2503.20563) - Fine-tuning and benchmarking toolkit for geospatial foundation models; integrates with GEO-Bench-2 and Hugging Face weights

* [torch-harmonics](https://github.com/NVIDIA/torch-harmonics) ⭐ 704 | 🐛 11 | 🌐 Jupyter Notebook | 📅 2026-09-23 - Differentiable signal processing on the sphere for geometric weather ML; BSD-3-Clause

* [WeatherBench 2](https://github.com/google-research/weatherbench2) ⭐ 638 | 🐛 89 | 🌐 Python | 📅 2026-09-10 [docs](https://weatherbench2.readthedocs.io/) - Open evaluation framework and leaderboard for data-driven global weather models
...
* [WeatherBench 2 ERA5 Zarr](https://github.com/google-research/weatherbench2) ⭐ 638 | 🐛 89 | 🌐 Python | 📅 2026-09-10 - Open cloud-optimized ERA5 and baseline forecast data for ML weather model training and evaluation
...
* [MTLCC](https://github.com/TUM-LMF/MTLCC) ⭐ 115 | 🐛 4 | 🌐 Jupyter Notebook | 📅 2021-11-19 - Multitemporal Land Cover Classification Network (ConvLSTM, ConvGRU),
...
* [Awesome Machine Learning](https://github.com/josephmisiti/awesome-machine-learning) ⭐ 74,413 | 🐛 20 | 🌐 Python | 📅 2026-09-22 - ![Awesome](media/icon/awesome.png) A curated list of awesome Machine Learning frameworks, libraries and software
* [Awesome Workflow Engines](https://github.com/meirwah/awesome-workflow-engines) ⭐ 7,933 | 🐛 73 | 📅 2026-09-21 - ![Awesome](media/icon/awesome.png) A curated list of awesome open source workflow engines
* [Awesome Pipeline](https://github.com/pditommaso/awesome-pipeline) ⭐ 6,628 | 🐛 32 | 📅 2026-09-21 - ![Awesome](media/icon/awesome.png) A curated list of awesome pipeline toolkits inspired by Awesome Sysadmin
...
* [MindsDB](https://github.com/mindsdb/mindsdb) ⭐ 39,762 | 🐛 6 | 🌐 Makefile | 📅 2026-09-16 – Explainable AutoML framework on PyTorch
* [Netron](https://github.com/lutzroeder/netron) ⭐ 33,512 | 🐛 18 | 🌐 JavaScript | 📅 2026-09-22 – Neural network and ONNX/Keras/TFLite model visualizer
* [MLflow](https://github.com/mlflow/mlflow) ⭐ 28,116 | 🐛 2,135 | 🌐 Python | 📅 2026-09-23 – Machine learning lifecycle platform
...
* [BentoML](https://github.com/bentoml/BentoML) ⭐ 8,856 | 🐛 222 | 🌐 Python | 📅 2026-09-07 – Open-source framework for high-performance ML model serving
* [flashlight](https://github.com/facebookresearch/flashlight) ⭐ 5,471 | 🐛 126 | 🌐 C++ | 📅 2026-09-14 – C++ standalone library for machine learning
* [SynapseML](https://github.com/microsoft/SynapseML) ⭐ 5,246 | 🐛 140 | 🌐 Scala | 📅 2026-09-22 – Scalable ML pipelines on Apache Spark
...
* [Polyaxon](https://github.com/polyaxon/polyaxon) ⭐ 3,735 | 🐛 125 | 🌐 MDX | 📅 2026-09-22 – ML platform for Kubernetes training and monitoring
* [TensorFlow Hub](https://github.com/tensorflow/hub) ⭐ 3,527 | 🐛 5 | 🌐 Python | 📅 2025-01-17 – Repository of reusable TensorFlow SavedModels
* [ml.js](https://github.com/mljs/ml) ⭐ 2,720 | 🐛 27 | 🌐 JavaScript | 📅 2024-10-21 – Machine learning tools in JavaScript
